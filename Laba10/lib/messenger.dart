abstract class Messenger{
  ...
  List<(String id, String user, String message)> get messages;
  set messages(List<(String id, String user, String message)> value);
  ...
  static List<(String id, String username, String message)> exportMessanges(Messenger messenger){
    return messenger.messages;
  }
  static void importMessanges(Messenger messenger, List<(String id, String username, String message)> data){
